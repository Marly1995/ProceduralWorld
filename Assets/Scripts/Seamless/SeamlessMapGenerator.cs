...
public class SeamlessMapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        noiseMap = null;
        SeamlessMapDisplay display = FindObjectOfType<SeamlessMapDisplay>();
...
public class NoiseFunctions     
{
    ...
    public void MakeNoise()
    {
        ...
        else if (type == NoiseType.RiggedMultifractal) { moduleBase = new RidgedMultifractal(frequency,lacunarity,octaves,seed,qualityMode);}
...
[System.Serializable]
public struct SeamlessTerrainType
{
    public string name;
